...
description_block = """A Flake8 plugin and pre-commit hook which checks to ensure modules have defined '__all__'.
...
source:
  url: "https://pypi.io/packages/source/f/flake8-dunder-all/flake8-dunder-all-{__version__}.tar.gz"
...
about:
  home: "https://github.com/domdfcoding/flake8-dunder-all"
  license: "MIT License"
  # license_family: LGPL
  # license_file: LICENSE
  summary: "A Flake8 plugin and pre-commit hook which checks to ensure modules have defined '__all__'."
  description: "{description_block}"
  doc_url: https://flake8-dunder-all.readthedocs.io
  dev_url: https://github.com/domdfcoding/flake8-dunder-all
